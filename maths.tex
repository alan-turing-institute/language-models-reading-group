...
Suppose $E\subset\mathcal{A}_X$ is an event.  The probability of $E$, denoted $P_X(E)$, is given by $P_X(E) = \sum_{a\in\mathcal{A}_X} p(a)$. 
...
inconsistencies and ambiguities. For example, informally, one often sees
